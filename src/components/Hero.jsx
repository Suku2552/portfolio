      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8  ,delay: 0.15 }}className="hidden md:flex items-center justify-center">
            <div className="h-64 w-64 rounded-xl bg-gradient-to-br from-brand to-indigo-400 flex items-center justify-center text-white font-bold text-4xl"><img src={profile} alt="suku" className=' rounded-xl' /></div>
          </motion.div>
        </div>
      </div>
    </section>
